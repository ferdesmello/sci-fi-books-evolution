...
def main():
    ...
    #output_file = './Data/Answers/sci-fi_books_AI_ANSWERS_TEST_Gemini.csv'
    #output_file = './Data/Answers/sci-fi_books_AI_ANSWERS_TEST_short_Gemini.csv'
    output_file = './Data/Answers/sci-fi_books_AI_ANSWERS_Gemini.csv'
