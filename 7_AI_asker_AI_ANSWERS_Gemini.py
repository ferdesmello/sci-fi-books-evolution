...
default_generation_config = {
    'max_output_tokens': 700,  # Set your desired default max tokens
...
def analyze_book(title: str , author: str, year: int, synopsis: str, review: str, plot: str, genres: List[str]) -> str: 
    ...
    Returns:
        answer (str): Gemini 2.0 processed entire answer.
    """
    ...
    **Questions**:
    1. Is the book considered more soft or hard sci-fi?
        ...
        Very hard: scientific accuracy on many sciences is important and integrated into the narrative, leaning towards extrapolation from known science.
    ...
    12. Is there a single protagonist or main character?
        Yes; 
        No (e.g., multiple protagonists or main characters);
    13. What is the gender of the single protagonist or main character?
        Male; 
        Female; 
        Other: the gender is ambiguous, uncertain, fluid, or neither male nor female;
        Non-human: the central character is non-human (e.g., animal, AI, robot, alien, etc); 
        Not applicable: no clear single protagonist or main character (e.g., more than one main character, humanity, etc).
...
def main():
    ...
    #input_file = './Data/sci-fi_books_TEST_Wiki.csv'
    #input_file = './Data/sci-fi_books_TEST_Wiki_short.csv'
    input_file = './Data/sci-fi_books_TOP_Wiki.csv'

    # Name of the output file
    #output_file = './Data/Variability_in_Answers_Gemini/sci-fi_books_AI_ANSWERS_TEST_Gemini_16.csv'
    #output_file = './Data/sci-fi_books_AI_ANSWERS_TEST_Gemini.csv'
    #output_file = './Data/sci-fi_books_AI_ANSWERS_TEST_short_Gemini.csv'
    output_file = './Data/sci-fi_books_AI_ANSWERS_Gemini.csv'
