"""
This script uses GPT-4o, via the OPENAI API, to answer questions about the plot 
...
def analyze_book(title: str , author: str, year: int, synopsis: str, review: str, plot: str, genres: List[str]) -> str: 
    ...
    Returns:
        answer (str): GPT-4o entire processed answer.
    """
...
def main():
    ...
    #output_file = './Data/Variability_in_Answers_GPT/sci-fi_books_AI_ANSWERS_TEST_GPT_01.csv'
    #output_file = './Data/Answers/sci-fi_books_AI_ANSWERS_TEST_GPT.csv'
    #output_file = './Data/Answers/sci-fi_books_AI_ANSWERS_TEST_short_GPT.csv'
    output_file = './Data/Answers/sci-fi_books_AI_ANSWERS_GPT.csv'
