...
def main():
    ...
    df_AI = pd.read_csv('./Data/Answers/sci-fi_books_AI_ANSWERS_GPT.csv', sep = ';', encoding="utf-8-sig")
    df_AI_gender = pd.read_csv('./Data/Answers/sci-fi_books_AI_ANSWERS_GENDER_GPT.csv', sep = ';', encoding="utf-8-sig")
    ...
    print(f"{counter} book(s) have been excluded from sci-fi_books_AI_ANSWERS_GPT.csv.")
    ...
    print(f"{counter_gender} name(s) have been excluded from sci-fi_books_AI_ANSWERS_GENDER_GPT.csv.")


    #----------------------------------------------------------------------------------
    df_cleaned.to_csv('./Data/Answers/sci-fi_books_AI_ANSWERS_GPT.csv', index=False, sep=';', encoding='utf-8-sig')
    df_cleaned_gender.to_csv('./Data/Answers/sci-fi_books_AI_ANSWERS_GENDER_GPT.csv', index=False, sep=';', encoding='utf-8-sig')
