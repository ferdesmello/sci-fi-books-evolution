...
def main():
    ...
    #output_file = './Data/sci-fi_books_AI_ANSWERS_TEST_GPT.csv'
    output_file = './Data/sci-fi_books_AI_ANSWERS_TEST_short_GPT.csv'
    #output_file = './Data/sci-fi_books_AI_ANSWERS_GPT.csv'
