...
df_top_AI = pd.read_csv("./Data/Answers/sci-fi_books_AI_ANSWERS_Gemini.csv", sep=";", encoding="utf-8-sig")
df_top_AI_gender = pd.read_csv("./Data/Answers/sci-fi_books_AI_ANSWERS_GENDER_Gemini.csv", sep=";", encoding="utf-8-sig")
...
figure_t1 = plt.figure(25, figsize = (18, 5))
