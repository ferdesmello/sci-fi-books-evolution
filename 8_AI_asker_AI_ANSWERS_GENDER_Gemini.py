...
def analyze_author(author: str) -> str:
    ...
    prompt = f"""
    You are an expert in science fiction literature.
...
def main():
    ...
    #input_file = './Data/sci-fi_books_AI_ANSWERS_Gemini.csv'

    # Name of the output file
    output_file = './Data/sci-fi_books_AI_ANSWERS_GENDER_Gemini.csv'
