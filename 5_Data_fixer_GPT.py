...
def main():
    ...
    df_AI = pd.read_csv('./Data/sci-fi_books_AI_ANSWERS_Gemini.csv', sep = ';', encoding="utf-8-sig")
    df_AI_gender = pd.read_csv('./Data/sci-fi_books_AI_ANSWERS_GENDER_Gemini.csv', sep = ';', encoding="utf-8-sig")
    ...
    #----------------------------------------------------------------------------------
    df_cleaned.to_csv('./Data/sci-fi_books_AI_ANSWERS_Gemini.csv', index=False, sep=';', encoding='utf-8-sig')
    df_cleaned_gender.to_csv('./Data/sci-fi_books_AI_ANSWERS_GENDER_Gemini.csv', index=False, sep=';', encoding='utf-8-sig')
